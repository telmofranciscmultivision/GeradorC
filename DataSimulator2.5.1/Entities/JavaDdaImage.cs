...
namespace EdpSimulator.Entities
{
    ...
    public class JavaDdaImage
    {
        ...
        public string HDDA_HST_INPUT_MOEDA {get;set;} = "1111";
        public string HDDA_HST_ORIG_MOEDA {get;set;} = "1111";
        ...
        public string HDDA_HST_CANAL {get;set;} = "1111";
